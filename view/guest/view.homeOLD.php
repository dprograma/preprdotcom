    ...
    <div class="container">
        <form method="get">
            <div class="row g-3">
                ...
                <div class="col">
                    <input type="text" name="exam_body" class="form-control" placeholder="Exam Body" aria-label="Exam Body">
                </div>
                <div class="col">
                    <input  type="date" name="year" class="form-control" placeholder="Year" aria-label="Year">
                </div>
                <div class="col">
                    <button type="submit" class="btn btn-primary" style="color: #fff; background-color: #347054; border-color: #347054; float: right;">Search</button>
                </div>
            </div>
        </form>
            ...
            try {
                ...
                foreach ($documents as $document) {
                    ...
                    <div class="col-12 col-md-4">
                        <div class="card">
                            <img src="<?= $document['coverpage']; ?>" class="card-img-top img-thumbnail rounded-0" alt="..."
                                style="height: 280px;">
                            <div class="card-body">
                                ...
                                <form action="checkout" method="post">
                                    ...
                                    <input type="submit" class="btn btn-primary"
                                        style="color: #fff; background-color: #347054; border-color: #347054;"
                                        value="Buy Past Question">
                                </form>
                            </div>
                        </div>
                    </div>
