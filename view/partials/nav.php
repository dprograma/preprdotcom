    ...
    <div class="offcanvas-body">
        <ul class="navbar-nav position-relative">
            ...
            <div class="navbar-nav ms-lg-4">
                <a class="nav-item nav-link" href="cart"><img src="<?= CART ?>" class="h-8" /></a>      
                <?php if ($cart_count > 0): ?>  
                <span class="text-center" style="color:brown; font-size: 14px; line-height: 18px; background-color: yellow; width: 18px; height: 18px; border-radius: 4px; transform: translate(45px, -40px);"><?=$cart_count?></span>
                <?php endif; ?>
            </div>
